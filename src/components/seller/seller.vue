...
<style>
  ...
  .seller .seller-content .overveiw {
    padding: 18px;
    position: relative;
  }

  .seller .seller-content .overveiw .title {
    margin-bottom: 8px;
    line-height: 14px;
    color: rgb(7, 17, 27);
    font-size: 14px;
  ...
  .seller .seller-content .overveiw .desc {
    padding-bottom: 18px;
    font-size: 0;
    border-bottom: 1px solid rgba(7, 17, 27, 0.1);
  }

  .seller .seller-content .overveiw .desc .star {
    display: inline-block;
    vertical-align: top;
    margin-right: 8px;
  }

  .seller .seller-content .overveiw .desc .text {
    display: inline-block;
    vertical-align: top;
    margin-right: 12px;
    line-height: 18px;
  ...
  .seller .seller-content .overveiw .remark {
    display: flex;
    padding-top: 18px;
  }

  .seller .seller-content .overveiw .remark .block {
    flex: 1;
    text-align: center;
    border-right: 1px solid rgba(7, 17, 27, 0.1);
  }

  .seller .seller-content .overveiw .remark .block:last-child {
    border: none;
  }

  .seller .seller-content .overveiw .remark .block h2 {
    margin-bottom: 4px;
    line-height: 10px;
    font-size: 10px;
  ...
  .seller .seller-content .overveiw .remark .block .content {
    line-height: 24px;
    font-size: 10px;
    color: rgb(7, 17, 27);
  }

  .seller .seller-content .overveiw .remark .block .content .stress {
    font-size: 24px;
  }

  .seller .seller-content .overveiw .favorite {
    position: absolute;
    right: 11px;
    top: 18px;
    width: 50px;
  ...
  .seller .seller-content .overveiw .favorite .icon-favorite {
    display: block;
    margin-bottom: 4px;
    line-height: 24px;
    font-size: 24px;
  ...
  .seller .seller-content .overveiw .favorite .icon-favorite.active {
    color: rgb(240, 20, 20);
  }

  .seller .seller-content .overveiw .favorite .text {
    line-height: 10px;
    font-size: 10px;
    color: rgb(77, 85, 93);
  }
